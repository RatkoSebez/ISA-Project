...
@Component({
  selector: 'app-weekend-cottage-report',
  templateUrl: './weekend-cottage-report.component.html',
  styleUrls: ['./weekend-cottage-report.component.css']
})
export class WeekendCottageReportComponent implements OnInit {
 ...
 rating = 0.0
  ...
  constructor(private http: HttpClient, public component: WeekendCottageInfoPageComponent) { Chart.register(...registerables)}

  ngOnInit(): void {
    this.rating = this.component.weekendCottage.rating
    var x = this.component.id
    var y: number = +x
    this.http.post<any>('api/weekendCottage/numResYearCottage', this.component.id).subscribe(response => {
  ...
  monthrep(year:any){
    ...
    this.http.post<any>('api/weekendCottage/numResMontCottage', postData ).subscribe((response:any) => {
  ...
  selectDays() {
    ...
    this.http.post<any>('api/weekendCottage/numResSpecWeekCottage', data ).subscribe((response:any) => {
      this.http.post<any>('api/weekendCottage/numResWeekCottage', data ).subscribe((response:any) => {
  ...
  selectDaysIncome() {
    ...
    if (this.startDateIncome || this.endDateIncome) {
      ...
      this.http.post<any>('api/weekendCottage/incomeSpecWeekCottage', dto ).subscribe((response:any) => {
