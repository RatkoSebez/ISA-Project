...
public class IsaProjekatApplication implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        weekendCottageRepository.save(new WeekendCottage("vikendica", "adresa6", "ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ovo je opis vikendice ", 4.5, "pravila", "https://cdn.pixabay.com/photo/2016/12/06/14/33/log-cabin-1886620_960_720.jpg", 4L, "cenovnik", additionalServices));
        weekendCottageRepository.save(new WeekendCottage("vikendica2", "adresa2", "ovo je opis vikendice", 4.55, "pravila", "https://cdn.pixabay.com/photo/2016/12/06/14/33/log-cabin-1886620_960_720.jpg", 4L, reservationsCottage, "cenovnik", additionalServices));
        weekendCottageRepository.save(new WeekendCottage("vikendica3", "adresa4", "ovo je opis vikendice", 3.5, "pravila", "https://cdn.pixabay.com/photo/2016/12/06/14/33/log-cabin-1886620_960_720.jpg", 4L, "cenovnik", additionalServices));
        weekendCottageRepository.save(new WeekendCottage("vikendica4", "adresa3", "ovo je opis vikendice", 4.0, "pravila", "https://cdn.pixabay.com/photo/2016/12/06/14/33/log-cabin-1886620_960_720.jpg", 4L, "cenovnik", additionalServices));
        weekendCottageRepository.save(new WeekendCottage("vikendica5", "adresa7", "ovo je opis vikendice", 3.2, "pravila", "https://cdn.pixabay.com/photo/2016/12/06/14/33/log-cabin-1886620_960_720.jpg", 4L, "cenovnik", additionalServices));
