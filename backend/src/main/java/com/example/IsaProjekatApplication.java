...
public class IsaProjekatApplication implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
       ...
       // userRepository.save(new User("test@gmail.com", "$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", UserRole.ROLE_BOATOWNER));
        ...
        userRepository.save(new User("$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", "user@gmail.com", "name", "prezime", "adresa", "grad", "drzava", "1235", UserRole.ROLE_CLIENT, adventures));
        ...
        userRepository.save(new User("Nikola", "$2a$10$K/udAutzf0mwWsNiZgsCme2i9KJ/15sqeqDZL7TWR/Lkc7Ii.BSye", "nidzo", "Instruktor Nidzo", "Cottage", "AdresaAdmin", "NS", "Serb", "12412412", UserRole.ROLE_FISHINGI, false));
        //FishingInstructor
