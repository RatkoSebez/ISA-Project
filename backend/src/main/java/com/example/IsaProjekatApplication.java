...
public class IsaProjekatApplication implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
       ...
       // userRepository.save(new User("user2", "$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra", UserRole.ROLE_ADMIN));
        userRepository.save(new User("admin@gmail.com", "123", "administrator@gmail.com", "ImeAdmin", "PrezimeAdmin", "AdresaAdmin", "NS", "Serb", "12412412", UserRole.ROLE_ADMIN, false));
        ...
        reservations.add(new ReservationBoat(LocalDate.of(2022, 1, 9), LocalDate.of(2022, 1, 11), "user@gmail.com"));
